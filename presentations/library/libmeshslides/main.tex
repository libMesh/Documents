...
\leftheader{\href{http://cfdlab.ae.utexas.edu}{\includegraphics[height=\headheight]{figures/word3}}}
%\rightheader{\large{FEF05}}
%\rightheader{\includegraphics[height=\headheight]{figures/box_v}}
\rightheader{}
\rightfooter{\thepage}
...
\newcommand{\dT}[1]{\frac{\partial}{\partial t}\left(#1\right)}
\newcommand{\dX}[1]{\frac{\partial}{\partial x}\left(#1\right)}
\newcommand{\dY}[1]{\frac{\partial}{\partial y}\left(#1\right)}
\newcommand{\vu}{\vec{u}}
...
\input fourth_slides
%\input divfree_slides
%\input heindl_slides
%\input clough_slides
%\input driven_slides
%\input results_slides
