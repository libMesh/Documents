...
\begin{frame}{Natural Refinement Patterns}
  \begin{tabular}{ccc}\\
    \includegraphics[angle=-90, width=.45\textwidth]{figures/triangle_refinement} &&
    \includegraphics[angle=-90, width=.45\textwidth]{figures/quad_refinement} \\
    Triangle && Quadrilateral \\
    \includegraphics[angle=-90, width=.45\textwidth]{figures/tet_refinement} &&
    \includegraphics[angle=-90, width=.45\textwidth]{figures/prism_refinement}  \\
    Tetrahedron && Prism 
  \end{tabular}
\end{frame}
...
\end{itemize}
      ...
      \column{.35\textwidth}
  \begin{center}
    \includegraphics[viewport=50 50 700 600,width=.9\textwidth]{figures/bl}
  \end{center}
  \end{columns}
\end{frame} 
...
\begin{frame}%{1D Example (cont.)}
  ...
  {
    \begin{tabular}{cc} \\
      \includegraphics[angle=-90,width=.42\textwidth]{figures/u_bl_5elems}&
      \includegraphics[angle=-90,width=.42\textwidth]{figures/up_bl_5elems} \\
      \includegraphics[angle=-90,width=.42\textwidth]{figures/eta_bl_5elems}&
      $\begin{array}{c}
        \text{4 elements} \\
        ||e||_{L_2} = 0.09
      \end{array}$\\
  ...
  {
    \begin{tabular}{cc} \\
      \includegraphics[angle=-90,width=.42\textwidth]{figures/u_bl_9elems}&
      \includegraphics[angle=-90,width=.42\textwidth]{figures/up_bl_9elems} \\
      \includegraphics[angle=-90,width=.42\textwidth]{figures/eta_bl_9elems}&
      $\begin{array}{c}
        \text{8 elements} \\
        ||e||_{L_2} = 0.027
      \end{array}$\\
  ...
  {
    \begin{tabular}{cc} \\
      \includegraphics[angle=-90,width=.42\textwidth]{figures/u_bl_17elems}&
      \includegraphics[angle=-90,width=.42\textwidth]{figures/up_bl_17elems} \\
      \includegraphics[angle=-90,width=.42\textwidth]{figures/eta_bl_17elems}&
      $\begin{array}{c}
        \text{16 elements} \\
        ||e||_{L_2} = 0.0071
      \end{array}$\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
  \only<1> {  \includegraphics[width=.7\textwidth,angle=-90]{figures/adaptive_u_bl_2elems} }
  \only<2> {  \includegraphics[width=.7\textwidth,angle=-90]{figures/adaptive_u_bl_3elems} }
  \only<3> {  \includegraphics[width=.7\textwidth,angle=-90]{figures/adaptive_u_bl_4elems} }
  \only<4> {  \includegraphics[width=.7\textwidth,angle=-90]{figures/adaptive_u_bl_5elems} }
  \only<5> {  \includegraphics[width=.7\textwidth,angle=-90]{figures/adaptive_u_bl_6elems} }
  \only<6> {  \includegraphics[width=.7\textwidth,angle=-90]{figures/adaptive_u_bl_7elems} }
  \only<7> {  \includegraphics[width=.7\textwidth,angle=-90]{figures/adaptive_u_bl_8elems} }
  \only<8> {  \includegraphics[width=.7\textwidth,angle=-90]{figures/adaptive_u_bl_9elems} }
  \only<9> {  \includegraphics[width=.7\textwidth,angle=-90]{figures/adaptive_u_bl_10elems} }
  \only<10> {  \includegraphics[width=.7\textwidth,angle=-90]{figures/adaptive_u_bl_11elems} }
  \only<11> {  \includegraphics[width=.7\textwidth,angle=-90]{figures/adaptive_u_bl_13elems} }
\end{frame}
...
\begin{frame}{A Simple Refinement Strategy (cont.)}
  \includegraphics[height=.9\textheight]{figures/error_plot}
\end{frame}
