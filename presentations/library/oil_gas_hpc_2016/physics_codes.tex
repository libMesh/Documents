  ...
  \begin{columns}
    ...
    \begin{column}{0.45\textwidth}
      \begin{center}
        ...
        \only<5>{\includegraphics[height=\linewidth]{ablating_hs_wbg}}
      \end{center}
    \end{column}
  \end{columns}
}
...
\frame
{
  ...
  \begin{center}
    ...
    \only<1>{\includegraphics[height=.65\textheight]{falcon/falcon_geothermal.png}}

    \only<2>{\includemovie[autoplay,loop,text={\includegraphics[height=.65\textheight]{falcon/falcon_geothermal.png}}]{}{.65\textheight}{falcon/anim_FALCON.avi}}
...
\frame
{
  ...
  \begin{center}
    ...
    \only<1>{\includegraphics[height=.75\textheight]{falcon/falcon_transport.png}}

    \only<2>{\includemovie[autoplay,loop,text={\includegraphics[height=.75\textheight]{falcon/falcon_transport.png}}]{}{.75\textheight}{falcon/moose_falcon_porous_flow.mov}}
