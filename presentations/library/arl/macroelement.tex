...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\royslide{$C^1$ Finite Element Spaces}{
In the Galerkin formulation of Cahn-Hilliard transport, we find
integrated products of second derivatives of trial and test functions.

We use $C^1$ continuous ,$W^{2,p}$ conforming finite elements:

\begin{minipage}[h]{.4\textwidth}
\royitemizebegin{Element Types}
\item Clough-Tocher macroelement triangles
\item Bogner-Fox-Schmidt squares, analogous Hermite cubes
\royitemizeend
\end{minipage}
\begin{minipage}[h]{.5\textwidth}
\begin{center}
\includegraphics[width=.9\textwidth]{figs/elements}
\end{center}
\end{minipage}
}
