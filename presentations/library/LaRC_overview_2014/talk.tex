...
\title[The \texttt{libMesh} Finite Element Library]{The \texttt{libMesh} Finite Element Library \\ \vspace{.5em} \emph{\large A Minimal Introduction}}
\author[the \texttt{libMesh} team]{Benjamin S.\ Kirk$^\dagger$ \\ \texttt{\scriptsize benjamin.kirk@nasa.gov} \\
  Roy H.\ Stogner$^\star$ \\
  John W.\ Peterson$^\ddagger$ \\
  Derek R.\ Gaston$^\ddagger$}
\institute[NASA, INL, UT]{$^\dagger$NASA Lyndon B. Johnson Space Center, USA \\ $^\ddagger$Idaho National Labs, USA \\ $^\star$The University of Texas at Austin, USA}
\date{\today}
