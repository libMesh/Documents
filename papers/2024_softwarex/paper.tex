...
\title{libMesh: A Flexible Finite Element Library}
...
\author[label1]{Roy Stogner}
\author[label1]{Alexander Lindsay}
\author[label2]{John Peterson}
\address[label1]{Idaho National Laboratory}
\address[label2]{Akselos}
